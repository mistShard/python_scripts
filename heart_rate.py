...
def populate_main_window(frm_main):
    ...
    ent_age = nent.IntEntry(frm_main, 12, 90, width=50)

    # Create a label that displays "Rates:"
    lbl_rates = tk.Label(frm_main, text="Rates:")
    lbl_me = tk.Label(frm_main, text="What the heck is this/")
    ...
    btn_next = tk.Button(frm_main, text="Next")
    ...
    lbl_me.grid( row=2, column=2, padx=3, pady=3)
    btn_next.grid( row=1, column=(4), padx=(3, 0), pady=3)
